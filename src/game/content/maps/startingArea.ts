...
const treeInstances = [
  assembledTree('tree-northwest-1', 96, 88, 32, 'screen-frame', ['unknown-woods', 'first-zone', 'edge-growth'], {
    canopyOffsetY: -174,
    canopyRadiusX: 108,
    canopyRadiusY: 84,
    scaleX: 0.98,
  ...
  assembledTree('tree-northwest-2', 178, 86, 30, 'screen-frame', ['unknown-woods', 'first-zone', 'edge-growth'], {
    canopyOffsetY: -168,
    canopyRadiusX: 100,
    canopyRadiusY: 80,
    scaleX: 0.94,
  ...
  assembledTree('tree-north-1', 982, 82, 34, 'boundary', ['unknown-woods', 'edge-growth'], {
    canopyOffsetY: -180,
    canopyRadiusX: 114,
    canopyRadiusY: 86,
    scaleX: 1.04,
  ...
  assembledTree('tree-north-2', 1088, 92, 32, 'boundary', ['unknown-woods', 'edge-growth'], {
    canopyOffsetY: -174,
    canopyRadiusX: 108,
    canopyRadiusY: 84,
    scaleX: 1,
  ...
  assembledTree('tree-north-3', 1296, 104, 34, 'boundary', ['unknown-woods', 'edge-growth'], {
    canopyOffsetY: -182,
    canopyRadiusX: 116,
    canopyRadiusY: 88,
    scaleX: 1.06,
  ...
  assembledTree('tree-north-4', 1404, 118, 34, 'boundary', ['unknown-woods', 'edge-growth'], {
    canopyOffsetY: -176,
    canopyRadiusX: 110,
    canopyRadiusY: 84,
    scaleX: 1.02,
  ...
  assembledTree('tree-southwest-1', 94, 744, 34, 'screen-frame', ['unknown-woods', 'first-zone', 'edge-growth'], {
    canopyOffsetY: -180,
    canopyRadiusX: 114,
    canopyRadiusY: 86,
    scaleX: 1.04,
  ...
  assembledTree('tree-southwest-2', 166, 742, 32, 'screen-frame', ['unknown-woods', 'first-zone', 'edge-growth'], {
    canopyOffsetY: -172,
    canopyRadiusX: 106,
    canopyRadiusY: 82,
    scaleX: 0.98,
  ...
  assembledTree('tree-south-1', 994, 738, 28, 'boundary', ['unknown-woods', 'edge-growth'], {
    canopyRadiusX: 112,
    canopyRadiusY: 86,
    scaleX: 1.04,
    scaleY: 1.04,
  ...
  assembledTree('tree-south-2', 1092, 744, 28, 'boundary', ['unknown-woods', 'edge-growth'], {
    canopyOffsetY: -172,
    canopyRadiusX: 104,
    canopyRadiusY: 80,
    scaleX: 0.96,
  ...
  assembledTree('tree-southeast-1', 1368, 730, 36, 'boundary', ['unknown-woods', 'edge-growth'], {
    canopyOffsetY: -184,
    canopyRadiusX: 118,
    canopyRadiusY: 90,
    scaleX: 1.08,
  ...
  assembledTree('tree-zone1-shelter-1', 520, 392, 22, 'shelter', ['unknown-woods', 'first-zone']),
  assembledTree('tree-north-path', 568, 92, 32, 'threshold', ['unknown-woods', 'first-zone', 'edge-growth'], {
    canopyOffsetY: -174,
    canopyRadiusX: 106,
    canopyRadiusY: 82,
    scaleX: 0.98,
  ...
  assembledTree('tree-wild-1', 1070, 250, 34, 'wolf-cover', ['unknown-woods', 'wolf-territory'], {
    canopyOffsetY: -186,
    canopyRadiusX: 122,
    canopyRadiusY: 92,
    scaleX: 1.1,
  ...
  assembledTree('tree-wild-2', 1196, 268, 30, 'wolf-cover', ['unknown-woods', 'wolf-territory'], {
    canopyOffsetY: -180,
    canopyRadiusX: 116,
    canopyRadiusY: 88,
    scaleX: 1.04,
  ...
  assembledTree('tree-wild-3', 1328, 300, 38, 'wolf-cover', ['unknown-woods', 'wolf-territory'], {
    canopyOffsetY: -190,
    canopyRadiusX: 126,
    canopyRadiusY: 94,
    scaleX: 1.12,
  ...
  assembledTree('tree-wild-4', 1268, 438, 38, 'resource-parent', ['unknown-woods', 'wolf-territory'], {
    canopyOffsetY: -184,
    canopyRadiusX: 120,
    canopyRadiusY: 90,
    scaleX: 1.08,
